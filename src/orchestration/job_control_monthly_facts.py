...
def get_previous_month_end(date):
...
def main():
    start_date = datetime(2024, 7, 31)  # Start at the last day of the first month
    ...
    while current_date >= end_date:
        ...
        # No need to check every date, directly process the month-end date
        ...
        current_date = get_previous_month_end(current_date)
