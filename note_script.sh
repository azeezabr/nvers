...
python3 test_scripts/old_key_script.py \
    ...
    --key_value='Endpoint=sb://nvs-event-hub-namespace.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=xSpVaJW0OetjNlbu+C50PJco+lu3cMzXb+AEhAI/mtA='
